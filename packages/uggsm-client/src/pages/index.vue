      ...
      items: [
        {
          ...
          beta: true,
          text:
            'Добавлено улучшенное отображение для таблицы заказов с гибкой системой фильтров и оптимизацией под мобильные устройства. Опробовать можно кликнув на это сообщение, или из меню внутри страницы заказов нажав на ссылку [Beta] Заказы.',
