...
export default class PageIndex extends Vue {
  public news = [
    {
      date: moment('11.04.2021', 'DD.MM.YYYY').format('DD MMMM YYYY'),
      items: [
        {
          type: 'feature',
          text: 'Добавлен отчёт по прибыли',
        },
      ],
    },
    {
      date: moment('10.04.2021', 'DD.MM.YYYY').format('DD MMMM YYYY'),
      items: [
        {
          type: 'feature',
          text: 'Улучшено внутренее отслеживание ошибок, добавлен способ обратной связи (иконка рупора слева в меню).',
        },
      ],
    },
    {
      date: moment('05.04.2021', 'DD.MM.YYYY').format('DD MMMM YYYY'),
      items: [
        {
          type: 'feature',
          text: 'Добавлены подсказки по заполнению некоторых полей создания нового офиса.',
        },
        {
          type: 'fix',
          text: 'Исправлено неккоректное создание заявок в офисе 8|Sochi из-за внутренней ошибки.',
        },
      ],
    },
    {
      date: moment('03.04.2021', 'DD.MM.YYYY').format('DD MMMM YYYY'),
      items: [
        {
          type: 'feature',
          text: 'Добавлена возможность указывать используемые запчасти в заказе.',
        },
        {
          type: 'fix',
          text: 'Исправлена некорректная начальная сортировка кассы.',
        },
      ],
    },
    {
      date: moment('30.03.2021', 'DD.MM.YYYY').format('DD MMMM YYYY'),
      items: [
        {
          type: 'fix',
          text:
            'Улучшено отображение на мобильных устройствах окна редактирования заказа (доступно только в новой таблице заказов).',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        {
          type: 'feature',
          text: 'Улучшено отображение на мобильных устройствах окна создания заказа.',
        },
        {
          type: 'feature',
          text: 'Улучшено отображение на мобильных устройствах окна создания гарантийного заказа.',
        },
        {
          type: 'fix',
          text:
            'Исправлено некорректное создание гарантийный заявок и, как следствие, неверный № Заказа в СМС уведомлении.',
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'feature',
          text: 'Улучшения в системе уведомлений об обновлении приложения.',
        },
      ],
    },
    {
